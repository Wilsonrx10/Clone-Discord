    ...
    <section class="container">
      ...
      <div class="formulario">
        ...
        <div>
          ...
          <input type="password" v-model="form.password" name="" autofocus required>
        </div>

        <div class="nascimento">
          <label for="email">Data nascimento</label>
          <div>
            <DropdowNascimento @nascimento="SalvarValorNascimento" :titulo="'Dia'" />
            <DropdowNascimento @nascimento="SalvarValorNascimento" :titulo="'Mes'" />
            <DropdowNascimento @nascimento="SalvarValorNascimento" :titulo="'Ano'" />
          </div>
        </div>
        ...
        <div class="footer">
          <div>
            <input type="checkbox">
            <p>Li e concordo com os termos de serviço e a política de privacidade</p>
          </div>
...
const SalvarValorNascimento = (payload, tipo) => {
  ...
  form.dataNascimento = nascimento.dia + '/' + nascimento.mes + '/' + nascimento.ano;
}
